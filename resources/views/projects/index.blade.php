...
@section("content")
 ...
 <a href="{{ route('projects.create') }}" class="bgtransparent hover:bg-blue-500 text-blue-700 font-semibold hover:textwhite py-2 px-4 border border-blue-500 hover:border-transparent rounded">
 {{ __("Crear proyecto") }}
 </a>
 </div>
 </div>
 <table class="border-separate border-2 text-center border-gray-500 mt3" style="width: 100%">
 <thead>
 <tr>
...
@csrf
 ...
 <tr>
 <td colspan="4">
 <div class="bg-red-100 text-center border border-red400 text-red-700 px-4 py-3 rounded relative" role="alert">
 <p><strong class="fontbold">{{ __("No hay proyectos") }}</strong></p>
